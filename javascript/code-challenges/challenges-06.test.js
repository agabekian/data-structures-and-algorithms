...
const countNumberOfElements = arr => arr.reduce(len => len + 1, 0);
...
const returnNames = arr => arr.reduce((names, entry) => {
...
const reversedString = str => str.split('').reduce((res, char) => char + res, '');
