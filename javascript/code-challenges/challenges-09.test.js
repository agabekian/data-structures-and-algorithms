...
const hasChildrenValues = (arr, character) => {
  ...
  for (let c in arr) {
      ...
      if (arr[c].name === character) {
          Object.keys(arr[c]).forEach((k, i) => {
              if (k === "children") {
                  children = Object.values(arr[c])[i].length
...
//thank Justin this was dreadful
